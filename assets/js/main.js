...
document.getElementById('pybutton').addEventListener('click', function() {
  section = document.getElementById('pybutton');
  document.getElementById('web-dev').classList.add('hidden');
...
document.getElementById('webdevbutton').addEventListener('click', function() {
  section = document.getElementById('webdevbutton');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  nextButton.addEventListener('click', function() {
      ...
      if (showMoreElements.length > 0 && count == 0) {
...
var section = document.getElementById('webdevbutton');
